...
// WebSocket
// пофиксить - неотображаются непрочитанные сообщения, пока тому кому они написаны не 
// отправит свое сообщение в чат
// пофиксить - некорректное отображение последнего сообщения в чате. Оно каждое свое
// для кажлого пользователя (последнее свое сообщение)
